 ...
 *
 * @nottodo: Use Cash or Underscore when jQuery is dropped by supported plugins.
 */
...
(function (root, factory) {
   ...
   *   The class name.
   */
  dBlazy.addClass = function (el, name) {
    if (el.classList) {
      el.classList.add(name);
    }
    else {
      if (!dBlazy.hasClass(el, name)) {
        el.className += ' ' + name;
      }
    }
  };
